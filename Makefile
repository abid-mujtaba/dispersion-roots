...
objectfiles = constants.o dispersion.o roots.o hypergeom.o infinite_kappa.o alpha.o term.o math_utilities.o
...
get-data:
	rsync -aP beast:projects/dispersion-roots/data/data-* data/
