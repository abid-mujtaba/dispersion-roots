...
int main(void)
{
        ...
        mpfr_t om_by_om_cj, coeff, h1f2, h2f3;
        mpfr_inits(om_by_om_cj, coeff, h1f2, h2f3, (mpfr_ptr) 0);

        calc_omega_by_omega_cj(om_by_om_cj, omega, OMEGA_CH);
        struct coeffs_1f2 c_1f2 = calc_coeffs_1f2(KAPPA_H, om_by_om_cj);
        struct coeffs_2f3 c_2f3 = calc_coeffs_2f3(KAPPA_H, om_by_om_cj);
        ...
        mpfr_clears(om_by_om_cj, coeff, h1f2, h2f3, (mpfr_ptr) 0);
