...
void get_constants_j(struct Constants * const c, double kappa, double rho, double n0j_by_n0e, double omega_c, char * str_lambda_vc_p2)
{
        ...
        mpfr_inits(c->kappa, c->lambda_vc_p2, c->omega_by_omega_c, c->two_lambda, c->csc, c->pi, c->sqrt_pi, (mpfr_t *) 0);
...
{
        mpfr_clears(c->kappa, c->lambda_vc_p2,  c->omega_by_omega_c, c->two_lambda, c->csc, c->pi, c->sqrt_pi, (mpfr_t *) 0);
}
