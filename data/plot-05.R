...
p <- p + ggtitle("Dispersion for $\\Lambda_c = 0.01$, $\\Lambda_h = 0.1$, $\\kappa_c = 2$, $\\displaystyle \\frac{n_{0h}}{n_{0e}}$, $\\displaystyle \\frac{T_h}{T_c} = 101.695$")
p <- p +
        ...
        scale_linetype_manual(name="$\\kappa_h$", values=c("1.6"="solid", "2.0"="dashed", "$\\inf$"="dotted")) +
